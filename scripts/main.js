$(function(s){
	"use strict";function e(s){
		"success"===s.result?swal("Good job!",s.msg,"success"):swal({
			title:"Error!",text:s.msg,type:"error",confirmButtonText:"Cool"
		})
	}s("#fullpage").fullpage({
		navigation:!0,navigationTooltips:
		["Home",
		"Features",
		"About Us",
		"Contact Us"],
		...
		separator:",",
		speed:4e3
	}),s("#countdown").countdown("2017/06/06",function(e){
	...
	}),s("[data-typer-targets]","#home").typer(),s(".slideshow-div","#fullpage").backstretch(
["images/DSC_0326.jpg",
"images/DSC_0322.jpg",
"images/DSC_0317.jpg",
"images/DSC_0327.jpg",
...
"images/DSC_0381.jpg"],{
	...
	url:"//themesease.us13.list-manage.com/subscribe/post?u=159f503811a2da9752c412bdb&amp;id=618ff52303",callback:e
});var a={success:function(){
	s("#form").clearForm(),swal("Thank You!","We will get back to you as soon as possible!","success")
}
};s("#form").ajaxForm(a);var o=s(window).width();991>o&&s(window).on("scroll resize",function(){
	...
	var e=s(this).data("clicks");e?s(".switcher").css("left","-200px"):s(".switcher").css("left","0px"),s(this).data("clicks",!e)
}),s(".color","#switcher").on("click",function(){
	var e=s(this).data("color-class");s("head").append("<link rel='stylesheet' href='styles/"+e+".css' type='text/css'>")}),s(".switch-header.light","#switcher").on("click",function(){
